...
.controller("communityCtrl", function($scope, geocodingService, communityService) {
  $scope.refresh=true;
...
// }
  ...
  $scope.searchType = 'amusement_park';
  $scope.getlocation = function (search) {
      ...
      communityService.getlocation("" +location.lat+ "," + location.lng, $scope.searchType)
