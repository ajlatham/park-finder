...
.controller("apiCtrl", function($scope, geocodingService, placesService) {
  $scope.refresh=true;
...
console.log($scope.parkType);
    ...
    placesService.getlocation("" +location.lat+ "," + location.lng, $scope.parkType ).then(function(response) {
