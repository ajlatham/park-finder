  ...
  .controller("stateCtrl", function($scope, geocodingService, stateService) {
    $scope.refresh=true;
  ...
  console.log($scope.parkType);
      ...
      stateService.getlocation("" +location.lat+ "," + location.lng, $scope.parkType ).then(function(response) {
